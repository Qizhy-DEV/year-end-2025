...
import { Camera, CameraOff, CheckCircle, User as UserIcon, Hash } from "lucide-react";
...
export default function QRScannerPage() {
    ...
    const handleManualCheckIn = async (e: React.FormEvent) => {
        ...
        await handleCheckIn(manualUserId);
        setManualUserId("");
    };
    ...
    return (
        <AdminLayout>
            <div className="space-y-6">
                {/* Header */}
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">Quét QR Check-in</h1>
